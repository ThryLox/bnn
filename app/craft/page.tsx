        ...
        <main className="min-h-screen bg-black text-white pt-24 px-8 md:px-20 pb-20">
            ...
            <header className="mb-16 max-w-4xl">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-white">
                    <span className="text-emerald-500">Craft</span> / Projects
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {projects.map((project) => (
                    <Link key={project.id} href={`/craft/${project.slug}`} className="group block">
                        <div className="h-full p-8 border border-zinc-800/50 rounded-2xl bg-zinc-900/10 hover:bg-zinc-900/30 transition-all duration-300 hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)]">
                            ...
                            <span className="text-emerald-500 text-sm font-medium group-hover:translate-x-2 transition-transform inline-block">
                                Read Case Study →
                            </span>
                        </div>
                    </Link>
